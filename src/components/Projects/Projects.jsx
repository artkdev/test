...
import { StyledProjects } from "./syles";
...
export default function Projects() {
  ...
  return (
    <StyledProjects>
      <img className="light" src={backLightRight} alt="" />
      <div className="wrapper">
        ...
        <p>
          From simple landing to latest technology software. <br />
          Our Customers always in touch for updates and support.
        </p>
        <SlidesCarousel />
